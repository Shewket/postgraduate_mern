...
export default function Header() {
    ...
    return (
        <header className='p-4 flex justify-between'>
            <Link to={'/'} className='flex item-center gap-1 relative top-1'>
            ...
            <span className="font-bold text-xl relative top-1.5">UOWForum</span>
            </Link>
            <div className='flex gap-3 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
                <div className='relative top-2'>Tag</div>
                <div className='border border-gray-300'></div>
                <div className='relative top-2'>Date</div>
                <div className='border border-gray-300'></div>
            ...
            <div to={user?'/account' : '/login'} className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 hover:border-gray-200' >
